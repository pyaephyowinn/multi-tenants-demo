...
import type { Route } from "./+types/tenant.dashboard";
      ...
      <div className="sm:flex sm:items-center">
        <div className="sm:flex-auto">
          ...
          <p className="mt-2 text-sm text-gray-700">
            Welcome to {tenant.name}'s CRM dashboard. Manage your contacts and conversations here.
          </p>
        </div>
        ...
        <div className="bg-white overflow-hidden shadow rounded-lg">
          <div className="p-5">
            <div className="flex items-center">
              ...
              <div className="ml-5 w-0 flex-1">
                <dl>
                  <dt className="text-sm font-medium text-gray-500 truncate">Schema</dt>
                  <dd className="text-lg font-medium text-gray-900">{tenant.schema_name}</dd>
                </dl>
              </div>
            </div>
          </div>
